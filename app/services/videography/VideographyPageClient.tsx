  ...
  return (
    <main className="min-h-screen pt-32 pb-32 px-4 md:px-8 bg-gradient-to-b from-brand-black from-70% to-brand-silver/10">
      ...
      >
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-brand-off-white/80 leading-relaxed pt-4 text-justify">
              ...
              <div className="pt-4 flex flex-row gap-4 items-center justify-center md:justify-start">
                ...
                >
                  <Link href="/portfolio#videography" className="inline-flex items-center gap-2 px-6 py-2.5 bg-transparent border-2 border-brand-off-white text-brand-off-white font-semibold text-sm rounded-md hover:bg-brand-off-white hover:text-brand-black transition-all duration-300 group">
                ...
                <motion.div
                  ...
                  transition={{ type: "spring", stiffness: 400, damping: 17 }}
                >
                  <Link href="/contact" className="inline-flex items-center gap-2 px-6 py-2.5 bg-brand-off-white text-brand-black font-semibold text-sm rounded-md hover:bg-white transition-all duration-300 group">
        ...
        <FaqSection faqs={videographyFaqs} />
      </motion.div>
