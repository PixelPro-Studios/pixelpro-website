        ...
        <div className="prose prose-invert max-w-none">
          <div className="text-brand-silver leading-relaxed space-y-8">
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">1. DEFINITIONS & ACCEPTANCE OF TERMS</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">2. RIGHTS</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">3. OWNERSHIP</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">4. LICENCE</h2>
                ...
                <h3 className="text-xl font-display font-semibold text-brand-platinum mt-4 mb-2">Use of Music in Videos</h3>
                ...
                <h3 className="text-xl font-display font-semibold text-brand-platinum mt-4 mb-2">Public Playback of Music, Background Music, or Event Music</h3>
                ...
                <h3 className="text-xl font-display font-semibold text-brand-platinum mt-4 mb-2">Movie Screenings, Film Clips, or Broadcast Content on LED Wall / Projection</h3>
                ...
                <h3 className="text-xl font-display font-semibold text-brand-platinum mt-4 mb-2">Artistic Licence</h3>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">5. COVERAGE & REPRODUCTIONS</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">6. EVENT ARRANGEMENTS</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">7. ON THE EVENT DAY</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">8. EDITING & POST-PRODUCTION</h2>
                ...
                <h3 className="text-xl font-display font-semibold text-brand-platinum mt-4 mb-2">8.1 Editing Style</h3>
                ...
                <h3 className="text-xl font-display font-semibold text-brand-platinum mt-4 mb-2">8.2 Post-Processing Scope</h3>
                ...
                <h3 className="text-xl font-display font-semibold text-brand-platinum mt-4 mb-2">8.3 Deliverable Format</h3>
                ...
                <h3 className="text-xl font-display font-semibold text-brand-platinum mt-4 mb-2">8.4 Revisions and Creative Limitations</h3>
                ...
                <h3 className="text-xl font-display font-semibold text-brand-platinum mt-4 mb-2">8.5 Storage & Archiving</h3>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">9. FORCE MAJEURE (BEYOND CONTROL)</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">10. CANCELLATION</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">11. LIMITATION OF LIABILITY</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">12. REFUND POLICY</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">13. INDEMNITY</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">14. ACCIDENT & DAMAGE</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">15. PAYMENTS</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">16. CORRECTIONS</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">17. RETURNS POLICY</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">18. PERSONAL DATA PROTECTION ACT (PDPA) COMPLIANCE</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">19. ENTIRE AGREEMENT</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">20. GOVERNING LAW</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-brand-off-white mb-3">21. SEVERABILITY</h2>
