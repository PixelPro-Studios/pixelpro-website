    ...
    <main className="min-h-screen pt-32 pb-32 px-4 md:px-8 bg-gradient-to-b from-brand-black from-70% to-brand-silver/10">
      ...
      >
        ...
        <div className="mb-16 space-y-8 text-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-display text-brand-off-white mb-4">
              Our story.
            </h1>
          </motion.div>
        ...
        >
          <div className="border-t border-brand-silver/20 pt-12 mb-8 text-center">
            <h2 className="text-3xl md:text-5xl font-display text-brand-off-white mb-6">
              What drives us
            </h2>
        ...
        >
          <div className="border-t border-brand-silver/20 pt-12 text-center">
            <h2 className="text-3xl md:text-5xl font-display text-brand-off-white mb-12">
              What we care about
            </h2>
              ...
              {values.map((value, index) => (
                ...
                >
                  <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <h3 className="text-xl font-display text-brand-off-white uppercase tracking-wide">
                      {value.title}
                    </h3>
