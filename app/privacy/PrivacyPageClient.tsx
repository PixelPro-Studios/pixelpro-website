      ...
      >
        ...
        <div className="prose prose-invert max-w-none">
          <div className="text-brand-silver leading-relaxed space-y-8 text-justify">
            ...
            <div>
              <h2 className="text-2xl font-display text-brand-off-white mb-4">1. General</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-display text-brand-off-white mb-4">2. Browsing</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-display text-brand-off-white mb-4">3. Data Sharing</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-display text-brand-off-white mb-4">4. Data Retention</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-display text-brand-off-white mb-4">5. External Links</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-display text-brand-off-white mb-4">6. Your Rights</h2>
              <p>
